  ...
  public void cookiesTest01() {
	 ...
	 driver.get("https://www.amazon.com/");
	  ...
	  for(Cookie cookie:cookiesWithMyCookyAdded) {
		  System.out.println("cookiesWithMyCookyAdded name and value: "+cookie.getName()+" : "+cookie.getValue());
	  }
	  ...
	  System.out.println("cookiesAfterDeletingOne name and value: "+cookie.getName()+" : "+cookie.getValue());
